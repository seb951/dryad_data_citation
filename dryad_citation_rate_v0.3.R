...
####
#this table is created by searching for all Molecular Ecology papers published between 2010-2016 on web of science's Core collection. Then refining it only for document types "articles". Downloading citations "full record and cited references" in the "other reference format (tab-delimited mac)". Then concatenating everything. 
#also remove the fuking apostrophe's.!!!!!

me = read.table("../webofscience/molecular_ecology/ME_2010_2016_2263papers.txt", stringsAsFactors = F, header = T)
